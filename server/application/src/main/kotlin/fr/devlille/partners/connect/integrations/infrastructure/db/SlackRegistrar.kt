...
class SlackRegistrar : IntegrationRegistrar<CreateSlackIntegration> {
    override val supportedUsages = setOf(IntegrationUsage.NOTIFICATION)

    override fun register(eventId: UUID, usage: IntegrationUsage, input: CreateSlackIntegration): UUID = transaction {
    ...
    override fun supports(input: CreateIntegration): Boolean = input is CreateSlackIntegration
}

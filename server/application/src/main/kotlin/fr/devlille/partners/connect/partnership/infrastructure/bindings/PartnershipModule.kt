...
import fr.devlille.partners.connect.partnership.application.PartnershipAssignmentRepositoryExposed
...
val partnershipModule = module {
    ...
    single<PartnershipAssignmentRepository> {
        PartnershipAssignmentRepositoryExposed()
    }

 ...
 */
class PartnershipListJobOffersRouteGetTest {
    @Test
    fun `GET partnership job offers returns 200 with empty list when no promotions exist`() = testApplication {
        ...
        val response = client.get("/events/$eventId/partnerships/$partnershipId/job-offers")
    ...
    fun `GET partnership job offers returns 200 with paginated results`() = testApplication {
        ...
        val response = client.get("/events/$eventId/partnerships/$partnershipId/job-offers?page=1&page_size=10")
    ...
    fun `GET partnership job offers returns 404 when event does not exist`() = testApplication {
        ...
        val response = client.get("/events/$eventId/partnerships/${UUID.randomUUID()}/job-offers")

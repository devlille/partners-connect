 ...
 */
class PartnershipDeletionRoutesTest {
    @Test
    fun `deleted partnership no longer appears in list`() = testApplication {
        ...
        val listBeforeResponse = client.get("/orgs/$orgId/events/$eventId/partnerships") {
        ...
        val listAfterResponse = client.get("/orgs/$orgId/events/$eventId/partnerships") {
            header(HttpHeaders.Authorization, "Bearer valid")
            header(HttpHeaders.Accept, "application/json")
        }
        ...
        val getByIdResponse = client.get("/events/$eventId/partnerships/$partnershipId") {
            header(HttpHeaders.Accept, "application/json")
        }

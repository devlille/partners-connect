...
class PartnershipBillingStatusRoutePostTest {
    @Test
    fun `POST updates billing status to PAID and returns 200 with billing id`() = testApplication {
        ...
        val response = client.post("/orgs/$orgId/events/$eventId/partnerships/$partnershipId/billing/PAID") {
    ...
    fun `POST handles case-insensitive billing status`() = testApplication {
        ...
        val response = client.post("/orgs/$orgId/events/$eventId/partnerships/$partnershipId/billing/sent") {
            header(HttpHeaders.Authorization, "Bearer valid")
        }
    ...
    fun `POST returns 400 for invalid billing status`() = testApplication {
        ...
        val response = client.post("/orgs/$orgId/events/$eventId/partnerships/$partnershipId/billing/UNKNOWN_STATUS") {
            header(HttpHeaders.Authorization, "Bearer valid")
        }

  ...
  <div>
    <main>
      ...
      <p class="description">
        ...
        <a
          target="_blank"
          href="https://philibert-consulting.sentry.io/issues/?project=4510385303322624"
          >Issues Page</a
        >. For more details about setting up Sentry,
        <a target="_blank" href="https://docs.sentry.io/platforms/javascript/guides/nuxt/"
          >read our docs</a
        >.
      </p>
      ...
      <p v-if="hasSentError" class="success">Sample error was sent to Sentry.</p>

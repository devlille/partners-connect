...
import { createMailjetConfig, createQontoConfig, createBilletwebConfig, createOpenPlannerConfig, createSlackConfig, createWebhookConfig } from '../helpers/integrationFactory';

describe('Integration Types', () => {
  describe('IntegrationProvider', () => {
    it('should accept valid provider types', () => {
      const providers: IntegrationProvider[] = ['QONTO', 'MAILJET', 'BILLETWEB', 'OPENPLANNER', 'SLACK', 'WEBHOOK'];

...
describe('useSponsorFilters', () => {
  ...
  describe('clearFilter', () => {
    ...
    it('should update activeFilterCount when clearing filters', () => {
      const { activeFilterCount, setPackFilter, setStatusFilter, clearFilter } = useSponsorFilters({ orgSlug, eventSlug })
  ...
  describe('clearAllFilters', () => {
    it('should reset all filters to initial state', () => {
      const { filters, setPackFilter, setStatusFilter, clearAllFilters } = useSponsorFilters({ orgSlug, eventSlug })
    ...
    it('should reset activeFilterCount to 0', () => {
      const { activeFilterCount, setPackFilter, setStatusFilter, clearAllFilters } = useSponsorFilters({ orgSlug, eventSlug })
    ...
    it('should clear queryParams', () => {
      const { queryParams, setPackFilter, setStatusFilter, clearAllFilters } = useSponsorFilters({ orgSlug, eventSlug })
  ...
  describe('activeFilterCount', () => {
    it('should count only non-null filter values', () => {
      const { activeFilterCount, setPackFilter, setStatusFilter } = useSponsorFilters({ orgSlug, eventSlug })
  ...
  describe('queryParams', () => {
    ...
    it('should include all active filters in queryParams', () => {
      const { queryParams, setPackFilter, setStatusFilter } = useSponsorFilters({ orgSlug, eventSlug })

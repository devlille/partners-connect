  ...
  describe('Document Generation - Quote', () => {
    ...
    describe('Quote Error Handling', () => {
      ...
      it('should format generic error message', () => {
        ...
        expect(formatQuoteError(error)).toBe('Une erreur est survenue lors de la génération du devis');
      });
  ...
  describe('Document Generation - Invoice', () => {
    ...
    describe('Invoice Error Handling', () => {
      ...
      it('should format generic error message', () => {
        ...
        const error = { response: { status: 500 } };
        expect(formatInvoiceError(error)).toBe('Une erreur est survenue lors de la génération de la facture');
      });

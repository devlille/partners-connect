...
export interface BudgetTotalsSchema {
  paid: number;
  validated: number;
  validated_minus_paid: number;
  total: number;
  total_minus_validated: number;
}

export type PartnershipBudgetItemSchemaStatus =
  (typeof PartnershipBudgetItemSchemaStatus)[keyof typeof PartnershipBudgetItemSchemaStatus];

export const PartnershipBudgetItemSchemaStatus = {
  paid: "paid",
  validated: "validated",
  submitted: "submitted",
} as const;

export interface PartnershipBudgetItemSchema {
...
export interface PackBudgetSchema {
  pack_id: string;
  pack_name: string;
  /** @minimum 0 */
  base_price: number;
  totals: BudgetTotalsSchema;
  partnerships: PartnershipBudgetItemSchema[];
}

export interface EventBudgetSchema {
  currency: string;
  totals: BudgetTotalsSchema;
  packs: PackBudgetSchema[];
}

export type EventBudget = EventBudgetSchema;

export type BudgetTotals = BudgetTotalsSchema;

export type PackBudget = PackBudgetSchema;

export type PartnershipBudgetItem = PartnershipBudgetItemSchema;
...
/**
 * Returns budget totals (paid, validated, total + diffs) and per-validated-pack breakdown listing partnerships with company name and price applied. Excludes declined partnerships.
 * @summary Get event budget
 */
export const getOrgsEventsBudget = (
  orgSlug: string,
  eventSlug: string,
  options?: SecondParameter<typeof customFetch<EventBudgetSchema>>,
) => {
  return customFetch<EventBudgetSchema>(
    { url: `/orgs/${orgSlug}/events/${eventSlug}/budget`, method: "GET" },
    options,
  );
};
...
export const postPartnershipEmailDraft = (
  ...
  return customFetch<DraftPartnershipEmailResponseSchema>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/partnerships/email/draft`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export type GetOrgsEventsBudgetResult = NonNullable<
  Awaited<ReturnType<typeof getOrgsEventsBudget>>
>;
...
>;
export type PostPartnershipEmailDraftResult = NonNullable<
  Awaited<ReturnType<typeof postPartnershipEmailDraft>>
>;
...
export type GetUsersMeFavoriteEventsResult = NonNullable<
  Awaited<ReturnType<typeof getUsersMeFavoriteEvents>>
>;
export type PutUsersMeFavoriteEventResult = NonNullable<
  Awaited<ReturnType<typeof putUsersMeFavoriteEvent>>
>;
export type DeleteUsersMeFavoriteEventResult = NonNullable<
  Awaited<ReturnType<typeof deleteUsersMeFavoriteEvent>>
>;

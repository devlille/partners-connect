...
export type FilterDefinitionSchemaValues = FilterValueSchema[] | null;
...
export interface FilterDefinitionSchema {
  ...
  values?: FilterDefinitionSchemaValues;
}
 ...
 */
export type PartnershipListResponseSchemaMetadata = PaginationMetadataSchema | null;
...
export interface PartnershipListResponseSchema {
  ...
  total: number;
  /** Pagination metadata containing available filters and sorts (always populated but nullable for backwards compatibility) */
  metadata?: PartnershipListResponseSchemaMetadata;
}

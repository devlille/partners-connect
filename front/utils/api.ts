...
export type EventStats = EventStatsSchema;

export type PartnerStats = PartnerStatsSchema;

export type JobOfferStats = JobOfferStatsSchema;

export type QandaStats = QandaStatsSchema;
...
export interface EcosystemPartnerCategorySchema {
  id: string;
  event_id: string;
  /**
   * @minLength 1
...
export interface EcosystemPartnerSchema {
  id: string;
  event_id: string;
  company_id: string;
  category: EcosystemPartnerCategorySchema;
  /**
   * @minimum 0
   * @nullable
   */
...
export type EcosystemPartner = EcosystemPartnerSchema;

export type EcosystemPartnerCategory = EcosystemPartnerCategorySchema;

export interface EcosystemPartnerItemSchema {
  id: string;
  company_name: string;
  /** @nullable */
...
export type EcosystemPartnerItem = EcosystemPartnerItemSchema;

export interface PublicEcosystemPartnerSchema {
  id: string;
  company_name: string;
  /** @nullable */
...
export type PublicEcosystemPartner = PublicEcosystemPartnerSchema;

export interface PublicEcosystemPartnerGroupSchema {
  category: string;
  partners: PublicEcosystemPartnerSchema[];
}

export type PublicEcosystemPartnerGroup = PublicEcosystemPartnerGroupSchema;

export interface RegisterEcosystemPartnerSchema {
  company_id: string;
  category_id: string;
  /**
   * @minimum 0
...
export type RegisterEcosystemPartner = RegisterEcosystemPartnerSchema;

export interface RegisterEcosystemPartnerCategorySchema {
  /**
   * @minLength 1
   * @maxLength 100
   */
...
export type RegisterEcosystemPartnerCategory = RegisterEcosystemPartnerCategorySchema;

export interface UpdateEcosystemPartnerSchema {
  /** @nullable */
...
export type UpdateEcosystemPartner = UpdateEcosystemPartnerSchema;

export interface UpdateEcosystemPartnerCategorySchema {
  /**
   * @minLength 1
   * @maxLength 100
   * @nullable
...
export type UpdateEcosystemPartnerCategory = UpdateEcosystemPartnerCategorySchema;
...
export interface PartnershipBoothLocationItemSchema {
  partnership: PartnershipItemSchema;
  /** @nullable */
  booth_location?: string | null;
}

export type PartnershipBoothLocationItem = PartnershipBoothLocationItemSchema;
...
export interface DeclineSupportVideoSchema {
  /**
   * Optional reason for declining the support video
   * @maxLength 500
   * @nullable
   */
  reason?: string | null;
...
export type DeclineSupportVideoRequest = DeclineSupportVideoSchema;

export type SupportVideoResponseSchemaStatus =
  (typeof SupportVideoResponseSchemaStatus)[keyof typeof SupportVideoResponseSchemaStatus];

export const SupportVideoResponseSchemaStatus = {
  PENDING: "PENDING",
  APPROVED: "APPROVED",
  DECLINED: "DECLINED",
} as const;

export interface SupportVideoResponseSchema {
  id: string;
  partnership_id: string;
  event_slug: string;
  url: string;
  status: SupportVideoResponseSchemaStatus;
  submitted_at: string;
  /** @nullable */
  reviewed_at?: string | null;
  /** @nullable */
...
export type SupportVideoResponse = SupportVideoResponseSchema;
...
/**
 * Discriminator value identifying this variant.
 */
export type WebhookPartnershipPayloadType =
  (typeof WebhookPartnershipPayloadType)[keyof typeof WebhookPartnershipPayloadType];

export const WebhookPartnershipPayloadType = {
 ...
 */
export type WebhookPartnershipPayloadEventType =
  (typeof WebhookPartnershipPayloadEventType)[keyof typeof WebhookPartnershipPayloadEventType];

export const WebhookPartnershipPayloadEventType = {
  CREATED: "CREATED",
  UPDATED: "UPDATED",
  DELETED: "DELETED",
} as const;

export type WebhookPartnershipPayloadResourceType =
  (typeof WebhookPartnershipPayloadResourceType)[keyof typeof WebhookPartnershipPayloadResourceType];

export const WebhookPartnershipPayloadResourceType = {
  PARTNERSHIP: "PARTNERSHIP",
} as const;
 ...
 */
export interface WebhookPartnershipPayload {
  /** Discriminator value identifying this variant. */
  type: WebhookPartnershipPayloadType;
  /** Type of event that triggered the webhook. */
  event_type: WebhookPartnershipPayloadEventType;
  resource_type: WebhookPartnershipPayloadResourceType;
  /** Identifier of the partnership resource. */
  resource_id: string;
  company: CompanySchema;
  event: EventSummarySchema;
  /** ISO-8601 timestamp at which the webhook was emitted. */
  timestamp: string;
  partnership: PartnershipDetailSchema;
  /** Job offers attached to the partnership. */
  jobs?: JobOfferResponseSchema[];
  /** Booth activities attached to the partnership. */
  activities?: BoothActivityResponseSchema[];
  /** Partnership Q&A questions and answers. */
  questions?: QandaQuestionSchema[];
  /** Speakers attached to the partnership. */
  speakers?: SpeakerSchema[];
  /**
   * URL of the validated support video, if any.
   * @nullable
   */
 ...
 * Discriminator value identifying this variant.
 */
export type WebhookEcosystemPartnerPayloadType =
  (typeof WebhookEcosystemPartnerPayloadType)[keyof typeof WebhookEcosystemPartnerPayloadType];

export const WebhookEcosystemPartnerPayloadType = {
 ...
 * Type of event that triggered the webhook.
 */
export type WebhookEcosystemPartnerPayloadEventType =
  (typeof WebhookEcosystemPartnerPayloadEventType)[keyof typeof WebhookEcosystemPartnerPayloadEventType];

export const WebhookEcosystemPartnerPayloadEventType = {
  CREATED: "CREATED",
  UPDATED: "UPDATED",
  DELETED: "DELETED",
} as const;

export type WebhookEcosystemPartnerPayloadResourceType =
  (typeof WebhookEcosystemPartnerPayloadResourceType)[keyof typeof WebhookEcosystemPartnerPayloadResourceType];

export const WebhookEcosystemPartnerPayloadResourceType = {
  ECOSYSTEM_PARTNER: "ECOSYSTEM_PARTNER",
} as const;
 ...
 */
export interface WebhookEcosystemPartnerPayload {
  /** Discriminator value identifying this variant. */
  type: WebhookEcosystemPartnerPayloadType;
  /** Type of event that triggered the webhook. */
  event_type: WebhookEcosystemPartnerPayloadEventType;
  resource_type: WebhookEcosystemPartnerPayloadResourceType;
  /** Identifier of the ecosystem partner resource. */
  resource_id: string;
  company: CompanySchema;
  event: EventSummarySchema;
  /** ISO-8601 timestamp at which the webhook was emitted. */
  timestamp: string;
  /** Display name of the ecosystem partner category. */
  category: string;
}

/**
 * Polymorphic webhook payload sent to subscribers. The `type` discriminator selects between a partnership notification and an ecosystem partner notification.
 */
export type WebhookPayload = WebhookPartnershipPayload | WebhookEcosystemPartnerPayload;
...
export type UploadSupportVideoBody = {
  file: Blob;
};
...
export type ListSupportVideosParams = {
  /**
   * Filter by support video status
   */
  status?: ListSupportVideosStatus;
  /**
   * Page number (1-indexed)
   * @minimum 1
   */
...
export type ListSupportVideosStatus =
  (typeof ListSupportVideosStatus)[keyof typeof ListSupportVideosStatus];

export const ListSupportVideosStatus = {
  pending: "pending",
  approved: "approved",
  declined: "declined",
} as const;

export type ListSupportVideos200 = {
  items?: SupportVideoResponseSchema[];
  total?: number;
  page?: number;
  page_size?: number;
};

export type ApproveSupportVideoBody = { [key: string]: unknown };
...
export type GetOrgsEventsEcosystemPartnersParams = {
  /**
   * Filter by ecosystem partner category UUID.
   */
  "filter[category_id]"?: string;
  /**
   * Filter by validation status. When true, only validated partners are returned.
   */
  "filter[validated]"?: boolean;
  /**
   * Filter by declined status. When absent or false (default), declined ecosystem partners are excluded from results. When true, declined partners are included.
   */
  "filter[declined]"?: boolean;
};
...
/**
 * Upload (or replace) the partnership's support video file (max 500 MB, video/mp4 or video/webm). The server stores it on Google Cloud Storage and records the public URL. Validation by an organiser is required before the URL is propagated via webhook.
 * @summary Upload support video
 */
export const uploadSupportVideo = (
  eventSlug: string,
  partnershipId: string,
  uploadSupportVideoBody: UploadSupportVideoBody,
  options?: SecondParameter<typeof customFetch<IdentifierSchema>>,
) => {
  const formData = new FormData();
  formData.append(`file`, uploadSupportVideoBody.file);

  return customFetch<IdentifierSchema>(
    {
      url: `/events/${eventSlug}/partnerships/${partnershipId}/support-video`,
      method: "POST",
      headers: { "Content-Type": "multipart/form-data" },
      data: formData,
    },
...
/**
 * Get the partnership's support video. Public endpoint accessible without authentication.
 * @summary Get support video
 */
export const getSupportVideo = (
  eventSlug: string,
  partnershipId: string,
  options?: SecondParameter<typeof customFetch<SupportVideoResponseSchema>>,
) => {
  return customFetch<SupportVideoResponseSchema>(
    { url: `/events/${eventSlug}/partnerships/${partnershipId}/support-video`, method: "GET" },
    options,
  );
};
...
export const createQandaQuestion = (
  ...
  return customFetch<QandaQuestionSchema>(
    {
      url: `/events/${eventSlug}/partnerships/${partnershipId}/qanda/questions`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export const updateQandaQuestion = (
  ...
  return customFetch<QandaQuestionSchema>(
    {
      url: `/events/${eventSlug}/partnerships/${partnershipId}/qanda/questions/${questionId}`,
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      data: qandaQuestionRequestSchema,
    },
...
/**
 * Returns per-partner statistics (job offers, activities, Q&A, tickets, social links, communication plan, speakers) for every non-declined partnership of the event.
 * @summary Get event partner stats
 */
export const getOrgsEventsStats = (
  orgSlug: string,
  eventSlug: string,
  options?: SecondParameter<typeof customFetch<EventStatsSchema>>,
) => {
  return customFetch<EventStatsSchema>(
    { url: `/orgs/${orgSlug}/events/${eventSlug}/stats`, method: "GET" },
    options,
  );
};

/**
 * List every non-declined partnership of the event with its booth location (or null).
 * @summary List booth locations
 */
export const getOrgsEventsBoothPlan = (
  orgSlug: string,
  eventSlug: string,
  options?: SecondParameter<typeof customFetch<PartnershipBoothLocationItemSchema[]>>,
) => {
  return customFetch<PartnershipBoothLocationItemSchema[]>(
    { url: `/orgs/${orgSlug}/events/${eventSlug}/booth-plan`, method: "GET" },
    options,
  );
};
...
export const postOrgsEventsBoothPlan = (
  ...
  return customFetch<PostOrgsEventsBoothPlan201>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/booth-plan`,
      method: "POST",
      headers: { "Content-Type": "multipart/form-data" },
      data: formData,
    },
...
export const putOrgsEventsPacksFlyerTemplate = (
  ...
  options?: SecondParameter<typeof customFetch<PutOrgsEventsPacksFlyerTemplate200>>,
) => {
  const formData = new FormData();
  ...
  return customFetch<PutOrgsEventsPacksFlyerTemplate200>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/packs/${packId}/flyer-template`,
      method: "PUT",
      headers: { "Content-Type": "multipart/form-data" },
      data: formData,
    },
...
export const postOrgsEventsPartnershipsFlyer = (
  ...
  return customFetch<PostOrgsEventsPartnershipsFlyer200>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/partnerships/${partnershipId}/flyer`,
      method: "POST",
    },
    options,
  );
...
/**
 * List support videos for an event, optionally filtered by status. Requires organization edit permissions.
 * @summary List support videos
 */
export const listSupportVideos = (
  orgSlug: string,
  eventSlug: string,
  params?: ListSupportVideosParams,
  options?: SecondParameter<typeof customFetch<ListSupportVideos200>>,
) => {
  return customFetch<ListSupportVideos200>(
    { url: `/orgs/${orgSlug}/events/${eventSlug}/support-videos`, method: "GET", params },
    options,
  );
};

/**
 * Approve a pending support video. Requires organization edit permissions. Sends notification to company and triggers webhook.
 * @summary Approve support video
 */
export const approveSupportVideo = (
  orgSlug: string,
  eventSlug: string,
  partnershipId: string,
  videoId: string,
  approveSupportVideoBody: ApproveSupportVideoBody,
  options?: SecondParameter<typeof customFetch<SupportVideoResponseSchema>>,
) => {
  return customFetch<SupportVideoResponseSchema>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/partnerships/${partnershipId}/support-videos/${videoId}/approve`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
      data: approveSupportVideoBody,
    },
    options,
  );
};
...
/**
 * Decline a pending support video with an optional reason. Requires organization edit permissions. Sends notification to company.
 * @summary Decline support video
 */
export const declineSupportVideo = (
  orgSlug: string,
  eventSlug: string,
  partnershipId: string,
  videoId: string,
  declineSupportVideoSchema: DeclineSupportVideoSchema,
  options?: SecondParameter<typeof customFetch<SupportVideoResponseSchema>>,
) => {
  return customFetch<SupportVideoResponseSchema>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/partnerships/${partnershipId}/support-videos/${videoId}/decline`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
      data: declineSupportVideoSchema,
    },
    options,
  );
};
...
/**
 * Create a new ecosystem partner category for an event. Categories group public partners (community sponsors, media partners, etc.) for display on the public event page.
 * @summary Create ecosystem partner category
 */
export const postOrgsEventsEcosystemPartnerCategory = (
  orgSlug: string,
  eventSlug: string,
  registerEcosystemPartnerCategorySchema: RegisterEcosystemPartnerCategorySchema,
  options?: SecondParameter<typeof customFetch<IdentifierSchema>>,
) => {
  return customFetch<IdentifierSchema>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/ecosystem-partner-categories`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
      data: registerEcosystemPartnerCategorySchema,
    },
    options,
  );
};
...
/**
 * List all ecosystem partner categories defined for the event, ordered by display order then name.
 * @summary List ecosystem partner categories
 */
export const getOrgsEventsEcosystemPartnerCategories = (
  orgSlug: string,
  eventSlug: string,
  options?: SecondParameter<typeof customFetch<EcosystemPartnerCategorySchema[]>>,
) => {
  return customFetch<EcosystemPartnerCategorySchema[]>(
    { url: `/orgs/${orgSlug}/events/${eventSlug}/ecosystem-partner-categories`, method: "GET" },
    options,
  );
};

/**
 * Update name and/or display order of an existing ecosystem partner category. All fields are optional for partial updates.
 * @summary Update ecosystem partner category
 */
export const putOrgsEventsEcosystemPartnerCategory = (
  orgSlug: string,
  eventSlug: string,
  categoryId: string,
  updateEcosystemPartnerCategorySchema: UpdateEcosystemPartnerCategorySchema,
  options?: SecondParameter<typeof customFetch<EcosystemPartnerCategorySchema>>,
) => {
  return customFetch<EcosystemPartnerCategorySchema>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/ecosystem-partner-categories/${categoryId}`,
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      data: updateEcosystemPartnerCategorySchema,
    },
    options,
  );
};
...
/**
 * Delete an ecosystem partner category. The operation fails if the category is referenced by any ecosystem partner.
 * @summary Delete ecosystem partner category
 */
export const deleteOrgsEventsEcosystemPartnerCategory = (
  orgSlug: string,
  eventSlug: string,
  categoryId: string,
  options?: SecondParameter<typeof customFetch<void>>,
...
/**
 * Public endpoint listing ecosystem partner categories for an event. Used by the public submission form to populate the category dropdown.
 * @summary Public list of ecosystem partner categories
 */
export const getEventsEcosystemPartnerCategories = (
  eventSlug: string,
  options?: SecondParameter<typeof customFetch<EcosystemPartnerCategorySchema[]>>,
) => {
  return customFetch<EcosystemPartnerCategorySchema[]>(
    { url: `/events/${eventSlug}/ecosystem-partner-categories`, method: "GET" },
    options,
  );
};

/**
 * Public endpoint allowing a company to submit itself as an ecosystem partner for an event. The submission lands in a pending state until an organiser validates or declines it.
 * @summary Submit ecosystem partner
 */
export const postEventsEcosystemPartners = (
  eventSlug: string,
  registerEcosystemPartnerSchema: RegisterEcosystemPartnerSchema,
  options?: SecondParameter<typeof customFetch<IdentifierSchema>>,
) => {
  return customFetch<IdentifierSchema>(
    {
      url: `/events/${eventSlug}/ecosystem-partners`,
      method: "POST",
      headers: { "Content-Type": "application/json" },
      data: registerEcosystemPartnerSchema,
    },
    options,
  );
};
...
/**
 * Public endpoint returning validated ecosystem partners grouped by category. Used to render the public event page.
 * @summary Public listing of validated ecosystem partners
 */
export const getEventsEcosystemPartners = (
  eventSlug: string,
  options?: SecondParameter<typeof customFetch<PublicEcosystemPartnerGroupSchema[]>>,
) => {
  return customFetch<PublicEcosystemPartnerGroupSchema[]>(
    { url: `/events/${eventSlug}/ecosystem-partners`, method: "GET" },
    options,
  );
};

/**
 * Public endpoint returning a single ecosystem partner submission by id. Used by the partner self-service edit form.
 * @summary Get ecosystem partner
 */
export const getEventsEcosystemPartner = (
  eventSlug: string,
  ecosystemPartnerId: string,
  options?: SecondParameter<typeof customFetch<EcosystemPartnerSchema>>,
) => {
  return customFetch<EcosystemPartnerSchema>(
    { url: `/events/${eventSlug}/ecosystem-partners/${ecosystemPartnerId}`, method: "GET" },
    options,
  );
};

/**
 * Public endpoint allowing the submitter to update an ecosystem partner. All fields are optional; only provided fields are updated. Triggers an updated webhook to subscribers.
 * @summary Update ecosystem partner submission
 */
export const putEventsEcosystemPartner = (
  eventSlug: string,
  ecosystemPartnerId: string,
  updateEcosystemPartnerSchema: UpdateEcosystemPartnerSchema,
  options?: SecondParameter<typeof customFetch<EcosystemPartnerSchema>>,
) => {
  return customFetch<EcosystemPartnerSchema>(
    {
      url: `/events/${eventSlug}/ecosystem-partners/${ecosystemPartnerId}`,
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      data: updateEcosystemPartnerSchema,
    },
    options,
  );
};
...
/**
 * List ecosystem partner submissions for an event, with optional filters by category and validation/decline state. Intended for the organiser dashboard.
 * @summary List ecosystem partners (organiser)
 */
export const getOrgsEventsEcosystemPartners = (
  orgSlug: string,
  eventSlug: string,
  params?: GetOrgsEventsEcosystemPartnersParams,
  options?: SecondParameter<typeof customFetch<EcosystemPartnerItemSchema[]>>,
) => {
  return customFetch<EcosystemPartnerItemSchema[]>(
    { url: `/orgs/${orgSlug}/events/${eventSlug}/ecosystem-partners`, method: "GET", params },
    options,
  );
};

/**
 * Delete an ecosystem partner submission. Sends a removal notification to the partner and triggers a deleted webhook to subscribers.
 * @summary Delete ecosystem partner
 */
export const deleteOrgsEventsEcosystemPartner = (
  orgSlug: string,
  eventSlug: string,
  ecosystemPartnerId: string,
  options?: SecondParameter<typeof customFetch<void>>,
  ...
  return customFetch<void>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/ecosystem-partners/${ecosystemPartnerId}`,
      method: "DELETE",
    },
    options,
  );
...
/**
 * Validate a pending ecosystem partner submission. The partner becomes visible on the public listing, the submitter receives a validation notification, and an updated webhook is sent.
 * @summary Validate ecosystem partner
 */
export const postOrgsEventsEcosystemPartnerValidate = (
  orgSlug: string,
  eventSlug: string,
  ecosystemPartnerId: string,
  options?: SecondParameter<typeof customFetch<IdentifierSchema>>,
  ...
  return customFetch<IdentifierSchema>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/ecosystem-partners/${ecosystemPartnerId}/validate`,
      method: "POST",
    },
    options,
  );
...
/**
 * Decline a pending ecosystem partner submission. The partner is hidden from the public listing, the submitter receives a decline notification, and an updated webhook is sent.
 * @summary Decline ecosystem partner
 */
export const postOrgsEventsEcosystemPartnerDecline = (
  orgSlug: string,
  eventSlug: string,
  ecosystemPartnerId: string,
  options?: SecondParameter<typeof customFetch<IdentifierSchema>>,
  ...
  return customFetch<IdentifierSchema>(
    {
      url: `/orgs/${orgSlug}/events/${eventSlug}/ecosystem-partners/${ecosystemPartnerId}/decline`,
      method: "POST",
    },
    options,
  );
...
>;
export type UploadSupportVideoResult = NonNullable<Awaited<ReturnType<typeof uploadSupportVideo>>>;
export type GetSupportVideoResult = NonNullable<Awaited<ReturnType<typeof getSupportVideo>>>;
...
>;
export type ListPartnershipQandaQuestionsResult = NonNullable<
  Awaited<ReturnType<typeof listPartnershipQandaQuestions>>
>;
export type CreateQandaQuestionResult = NonNullable<
  Awaited<ReturnType<typeof createQandaQuestion>>
>;
export type UpdateQandaQuestionResult = NonNullable<
  Awaited<ReturnType<typeof updateQandaQuestion>>
>;
export type DeleteQandaQuestionResult = NonNullable<
  Awaited<ReturnType<typeof deleteQandaQuestion>>
>;
export type ListEventQandaQuestionsResult = NonNullable<
  Awaited<ReturnType<typeof listEventQandaQuestions>>
>;
...
export type GetOrgsEventsStatsResult = NonNullable<Awaited<ReturnType<typeof getOrgsEventsStats>>>;
export type GetOrgsEventsBoothPlanResult = NonNullable<
  Awaited<ReturnType<typeof getOrgsEventsBoothPlan>>
>;
...
>;
export type PutOrgsEventsPacksFlyerTemplateResult = NonNullable<
  Awaited<ReturnType<typeof putOrgsEventsPacksFlyerTemplate>>
>;
export type DeleteOrgsEventsPacksFlyerTemplateResult = NonNullable<
  Awaited<ReturnType<typeof deleteOrgsEventsPacksFlyerTemplate>>
>;
export type PostOrgsEventsPartnershipsFlyerResult = NonNullable<
  Awaited<ReturnType<typeof postOrgsEventsPartnershipsFlyer>>
>;
...
>;
export type ListSupportVideosResult = NonNullable<Awaited<ReturnType<typeof listSupportVideos>>>;
export type ApproveSupportVideoResult = NonNullable<
  Awaited<ReturnType<typeof approveSupportVideo>>
>;
export type DeclineSupportVideoResult = NonNullable<
  Awaited<ReturnType<typeof declineSupportVideo>>
>;
...
export type PostOrgsEventsEcosystemPartnerCategoryResult = NonNullable<
  Awaited<ReturnType<typeof postOrgsEventsEcosystemPartnerCategory>>
>;
export type GetOrgsEventsEcosystemPartnerCategoriesResult = NonNullable<
  Awaited<ReturnType<typeof getOrgsEventsEcosystemPartnerCategories>>
>;
export type PutOrgsEventsEcosystemPartnerCategoryResult = NonNullable<
  Awaited<ReturnType<typeof putOrgsEventsEcosystemPartnerCategory>>
>;
export type DeleteOrgsEventsEcosystemPartnerCategoryResult = NonNullable<
  Awaited<ReturnType<typeof deleteOrgsEventsEcosystemPartnerCategory>>
>;
export type GetEventsEcosystemPartnerCategoriesResult = NonNullable<
  Awaited<ReturnType<typeof getEventsEcosystemPartnerCategories>>
>;
export type PostEventsEcosystemPartnersResult = NonNullable<
  Awaited<ReturnType<typeof postEventsEcosystemPartners>>
>;
export type GetEventsEcosystemPartnersResult = NonNullable<
  Awaited<ReturnType<typeof getEventsEcosystemPartners>>
>;
export type GetEventsEcosystemPartnerResult = NonNullable<
  Awaited<ReturnType<typeof getEventsEcosystemPartner>>
>;
export type PutEventsEcosystemPartnerResult = NonNullable<
  Awaited<ReturnType<typeof putEventsEcosystemPartner>>
>;
export type GetOrgsEventsEcosystemPartnersResult = NonNullable<
  Awaited<ReturnType<typeof getOrgsEventsEcosystemPartners>>
>;
export type DeleteOrgsEventsEcosystemPartnerResult = NonNullable<
  Awaited<ReturnType<typeof deleteOrgsEventsEcosystemPartner>>
>;
export type PostOrgsEventsEcosystemPartnerValidateResult = NonNullable<
  Awaited<ReturnType<typeof postOrgsEventsEcosystemPartnerValidate>>
>;
export type PostOrgsEventsEcosystemPartnerDeclineResult = NonNullable<
  Awaited<ReturnType<typeof postOrgsEventsEcosystemPartnerDecline>>
>;
